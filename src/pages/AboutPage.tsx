...
import { Book, Award, Users, BookOpen } from 'lucide-react';
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mb-12">
            <div className="p-6 md:p-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                EduBlog was created with a simple yet powerful mission: to make educational 
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              EduBlog is here to support your educational journey.
            </p>
            <a
              href="mailto:contact@edublog.com"
